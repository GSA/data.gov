...
update-vendor-verbose:
	ansible-galaxy install -$(KITCHEN_SUITE_TARGETS) le/roles/vendor -r ansible/roles/vendor/requirements.yml -vvv

update-vendor-force:
	ansible-galaxy install -$(KITCHEN_SUITE_TARGETS) le/roles/vendor -r ansible/roles/vendor/requirements.yml --force

update-vendor-force-verbose:$(KITCHEN_SUITE_TARGETS) 
