...
$config['base_url'] = 'https://labs-staging.data.gov/crm/';

if (function_exists('date_default_timezone_set')) {
    date_default_timezone_set('America/New_York');
}

//CR3726 added the two folling lines
$config['akismet_key'] = 'cdc4343fbe35';
$config['akismet_siteurl'] = 'http://www.data.gov';
...
if ($config['base_url']=='') {
  ...
  $config['base_url'] .= "://".$_SERVER['HTTP_HOST'].'/crm/';
}
