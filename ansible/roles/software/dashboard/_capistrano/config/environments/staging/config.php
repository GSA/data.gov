...
$config['download_dir'] = '/var/www/labs/dashboard/shared/downloads';
$config['archive_dir']  = '/var/www/labs/dashboard/shared/archive';
...
$config['tmp_csv_import'] = '/var/www/labs/dashboard/shared/downloads/import.csv';
...
|
*/
$config['base_url'] = 'https://labs-staging.data.gov/dashboard/' ;
...
$config['github_oauth_redirect'] = 'http://' . $_SERVER['SERVER_NAME'] . '/dashboard/auth/session/github';
